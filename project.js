/* Extracting data asynchronously from URL by using fetch() method.*/
/* I tried to extract data from resume.json local file. But Chrome is showing CORBS error message. Using URL is safer.*/
function loadInfo(){
    fetch('https://raw.githubusercontent.com/abdillahi09/CASE-STUDY---AJAX-PROJECT/master/resume.json')
...
/* This function extracts data from the resume.json URL by using XMLHttprequest()*/ 
/* If you extract data directly from resume.json. You will not be able to use CHROME. It will show CORBS error messages.*/

// function loadInfo(){
//     var xhr = new XMLHttpRequest();
//     var URL = "https://raw.githubusercontent.com/abdillahi09/CASE-STUDY---AJAX-PROJECT/master/resume.json";
